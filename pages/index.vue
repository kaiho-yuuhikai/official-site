    ...
    <section id="about" class="py-24 md:py-32 bg-white">
      <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-6 fade-in">
          <!-- Pillar 1 -->
          <div class="card-hover bg-gradient-to-br from-kaiho-green/5 to-emerald-50 rounded-2xl p-6 text-center border border-kaiho-green/10">
            <div class="w-14 h-14 bg-kaiho-green/10 rounded-xl flex items-center justify-center mx-auto mb-4">
            ...
            <h3 class="text-base font-bold text-neutral-900">在校生・同窓生支援</h3>
          </div>

          <!-- Pillar 2 -->
          <div class="card-hover bg-gradient-to-br from-kaiho-gold/5 to-amber-50 rounded-2xl p-6 text-center border border-kaiho-gold/10">
            <div class="w-14 h-14 bg-kaiho-gold/10 rounded-xl flex items-center justify-center mx-auto mb-4">
            ...
            <h3 class="text-base font-bold text-neutral-900">同窓生ネットワーク</h3>
          </div>

          <!-- Pillar 3 -->
          <div class="card-hover bg-gradient-to-br from-kaiho-blue/5 to-blue-50 rounded-2xl p-6 text-center border border-kaiho-blue/10">
            <div class="w-14 h-14 bg-kaiho-blue/10 rounded-xl flex items-center justify-center mx-auto mb-4">
            ...
            <h3 class="text-base font-bold text-neutral-900">社会貢献</h3>
          </div>
        </div>
      </div>
    </section>
