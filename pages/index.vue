    ...
    <section id="about" class="py-24 md:py-32 bg-white">
      <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-5 fade-in">
          <!-- Pillar 1 -->
          <div class="card-hover relative overflow-hidden bg-gradient-to-br from-kaiho-green to-kaiho-green-dark rounded-2xl p-7 text-white shadow-lg shadow-kaiho-green/20">
            <div class="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/2"></div>
            <div class="relative">
              <span class="text-xs font-black tracking-[0.2em] text-white/40 uppercase">01</span>
              <div class="w-12 h-12 bg-white/15 rounded-xl flex items-center justify-center my-3">
              ...
              <h3 class="text-base font-bold text-white">在校生・同窓生支援</h3>
            </div>
          </div>

          <!-- Pillar 2 -->
          <div class="card-hover relative overflow-hidden bg-gradient-to-br from-amber-500 to-amber-700 rounded-2xl p-7 text-white shadow-lg shadow-amber-500/20">
            <div class="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/2"></div>
            <div class="relative">
              <span class="text-xs font-black tracking-[0.2em] text-white/40 uppercase">02</span>
              <div class="w-12 h-12 bg-white/15 rounded-xl flex items-center justify-center my-3">
              ...
              <h3 class="text-base font-bold text-white">同窓生ネットワーク</h3>
            </div>
          </div>

          <!-- Pillar 3 -->
          <div class="card-hover relative overflow-hidden bg-gradient-to-br from-kaiho-blue to-blue-700 rounded-2xl p-7 text-white shadow-lg shadow-kaiho-blue/20">
            <div class="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/2"></div>
            <div class="relative">
              <span class="text-xs font-black tracking-[0.2em] text-white/40 uppercase">03</span>
              <div class="w-12 h-12 bg-white/15 rounded-xl flex items-center justify-center my-3">
              ...
              <h3 class="text-base font-bold text-white">社会貢献</h3>
            </div>
          </div>
        </div>
      </div>
