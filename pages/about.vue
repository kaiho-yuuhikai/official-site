<template>
  <div>
    <!-- Hero -->
    <section class="relative py-32 bg-kaiho-green-dark flex items-center justify-center">
      <div class="absolute inset-0 bg-gradient-to-br from-kaiho-green-dark via-kaiho-green to-kaiho-green-dark opacity-90"></div>
      <div class="relative z-10 text-center px-6 max-w-3xl mx-auto">
        <p class="text-kaiho-gold text-sm tracking-widest mb-4">About</p>
        <h1 class="text-4xl md:text-5xl font-light text-white tracking-tight">雄飛会について</h1>
      </div>
    </section>
    ...
    <section class="py-24 bg-white">
      <div class="max-w-4xl mx-auto px-6 lg:px-8">
        <div class="mb-16">
          ...
          <h2 class="section-title mb-6">理念・目的</h2>
        ...
        <div class="prose prose-neutral max-w-none">
          ...
          <h3 class="text-xl font-medium text-neutral-900 mt-12 mb-6">活動方針</h3>
          <div class="space-y-6">
            <div v-for="(policy, i) in policies" :key="i" class="flex gap-4">
              <span class="flex-shrink-0 w-8 h-8 rounded-full bg-kaiho-green/10 text-kaiho-green flex items-center justify-center text-sm font-medium">
                {{ i + 1 }}
              </span>
              <div>
                <h4 class="font-medium text-neutral-900">{{ policy.title }}</h4>
    ...
    <!-- 会則 -->
    <section class="py-24 bg-kaiho-cream/30">
      <div class="max-w-4xl mx-auto px-6 lg:px-8">
        <div class="mb-16">
          <p class="section-label">Bylaws</p>
          <h2 class="section-title mb-6">会則</h2>
          <div class="divider"></div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-8 shadow-sm">
          ...
          <div class="space-y-4">
            <div v-for="(section, i) in bylawSections" :key="i" class="border border-neutral-200 rounded-lg">
              ...
              >
                <span class="font-medium text-neutral-900 text-sm">{{ section.title }}</span>
                <svg
    ...
    <section class="py-24 bg-white">
      <div class="max-w-4xl mx-auto px-6 lg:px-8">
        <div class="mb-16">
          ...
          <h2 class="section-title mb-6">沿革</h2>
          <div class="divider"></div>
        </div>
        ...
        <div class="space-y-8">
          <div v-for="event in timeline" :key="event.year" class="flex gap-6">
            <div class="flex-shrink-0 w-20 text-right">
              <span class="text-sm font-medium text-kaiho-green">{{ event.year }}</span>
            </div>
            ...
            <div class="pb-8">
              <h4 class="font-medium text-neutral-900 text-sm">{{ event.title }}</h4>
...
const bylawSections = [
  {
    title: '第1章 総則（名称・目的）',
    content: '会則の詳細は現在整備中です。確定次第掲載いたします。',
  },
  {
    title: '第2章 会員',
    content: '会則の詳細は現在整備中です。確定次第掲載いたします。',
