...
const policies = [
  ...
  },
  {
    ...
    description: '開邦雄飛応援金やメンター制度、ICT活用を通じて、生徒の探究活動と成長を支援します。',
  },
  {
...
const timeline = [
  ...
  { year: '2006年', title: '開邦雄飛会 再始動', description: '「弁が岳の集い」（ななさんどー）に合わせて活動を本格再開。' },
  { year: '2010年', title: '第2代 上里直司会長 就任' },
  { year: '2011年', title: '創立記念日 特別授業 開始', description: '同窓生講師による授業。現在も続くメイン活動。' },
  { year: '2014年', title: '開邦雄飛会 設立25周年記念パーティ 開催' },
  { year: '2015年', title: '第1回 大同窓会 開催', description: '開邦高校創立３０周年記念' },
  { year: '2018年', title: '第2回 大同窓会 開催', description: '' },
  { year: '2019年7月', title: '令和元年度 開邦雄飛会総会 開催', description: '那覇市泉崎にて開催。以降、コロナ禍により中断。' },
  { year: '2025年12月', title: '第3回 大同窓会 開催', description: '開邦高校創立40周年記念。参加者537名。キャリア・クロスロード初開催。' },
  { year: '2026年3月', title: '組織再編会議', description: '若狭公民館にて活性化会議を開催。' },
]
