...
パソコンに特別なソフトが入っていなくても大丈夫です。下の1行をコピペするだけで、
**ソフトの導入・GitHubログイン・VS Codeの日本語化・サイトデータの取り込み**まで全部終わります。

途中でブラウザが2回開きます（GitHub と Claude のログイン）。合計10〜20分、ほとんどは待ち時間です。
終わると VS Code が自動で開きます。
