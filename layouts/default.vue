      ...
      <nav class="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="nav-group relative">
              ...
              <div class="nav-dropdown absolute top-full left-0 pt-2 w-52">
                <div class="bg-white rounded-lg shadow-xl py-2 border">
                  ...
                  <NuxtLink to="/activities/special-lecture-2026" class="block px-4 py-2 text-sm text-neutral-700 hover:bg-kaiho-green/10 hover:text-kaiho-green">令和8年度 講師募集</NuxtLink>
                  <a href="https://note.com/kaihoyuuhikai/m/m20c04499fc49" target="_blank" rel="noopener noreferrer" class="block px-4 py-2 text-sm text-neutral-700 hover:bg-kaiho-green/10 hover:text-kaiho-green">道路清掃ボランティア ↗</a>
                </div>
              </div>
            </div>
        ...
        <div class="mobile-menu lg:hidden" :class="{ open: mobileMenuOpen }">
          <div class="bg-white rounded-b-xl shadow-xl py-4 px-4 space-y-3">
            ...
            <NuxtLink to="/activities/special-lecture-2026" class="block text-sm text-neutral-700 hover:text-kaiho-green py-2" @click="mobileMenuOpen = false">令和8年度 講師募集</NuxtLink>
            <a href="https://note.com/kaihoyuuhikai/m/m20c04499fc49" target="_blank" rel="noopener noreferrer" class="block text-sm text-neutral-700 hover:text-kaiho-green py-2" @click="mobileMenuOpen = false">道路清掃ボランティア ↗</a>
